...
**DiGi.GIS.IO** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.GIS.IO](DiGi.GIS.IO)** (Path: `DiGi.GIS.IO\DiGi.GIS.IO`)
