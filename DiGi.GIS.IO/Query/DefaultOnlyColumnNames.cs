...
namespace DiGi.GIS.IO
{
    public static partial class Query
    {
        ...
        /// <para>See <see cref="UnpopulatedColumnNames(DiGi.Core.IO.Table.Classes.Table?, System.Collections.Generic.IEnumerable{DiGi.Core.IO.Table.Classes.Column}?)"/> for the neighbouring question on the inference side - not which columns never vary, but which carry nothing at all.</para>
